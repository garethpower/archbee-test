---
title: StreamForge Ingest Data Ingestion Technical Details
docTags: 
...
- drop\_columns, cast, filter, flatten
...
- streamforge\_ingest\_records\_total
- streamforge\_ingest\_lag\_seconds
- streamforge\_processor\_failures\_total
- streamforge\_sink\_commits\_total
- streamforge\_dlq\_records\_total
...
Structured logs include request\_id, pipeline\_id, offset, and sink\_txn\_id.
